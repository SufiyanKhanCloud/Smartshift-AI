...
<div class="report-container">
  ...
  <section style="background:#f7fafc;text-align:center;padding:20px 40px">
    ...
    <button id="report-print-btn" class="no-print" style="margin-top:12px;padding:8px 20px;background:#00d4aa;color:#0d1b2a;border:none;border-radius:6px;font-weight:700;cursor:pointer;font-size:0.88rem">🖨 Print / Save as PDF</button>
  </section>
</div>
<script src="${location.origin}/static/js/report-print.js"></script>
</body></html>`;
